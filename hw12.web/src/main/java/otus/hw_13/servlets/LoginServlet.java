...
import static otus.hw_13.constants.Constants.DEFAULT_ADMIN_PASSWORD;
import static otus.hw_13.constants.Constants.LOGGED_IN_PAGE_TEMPLATE;
import static otus.hw_13.constants.Constants.LOGIN_PAGE_TEMPLATE;
...
public class LoginServlet extends HttpServlet
{
    ...
    private void saveToServlet(HttpServletRequest request, String requestLogin) {
        request.getServletContext().setAttribute(LOGIN_PARAMETER_NAME, requestLogin);
    }
    ...
    private void saveToSession(HttpServletRequest request, String requestLogin, String requestPassword) {
        ...
        request.getSession().setAttribute(PASSWORD_PARAMETER_NAME, requestPassword);
    }
