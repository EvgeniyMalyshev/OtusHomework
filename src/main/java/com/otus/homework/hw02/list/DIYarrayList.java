...
public class DIYarrayList<E> implements List<E> {
    ...
    public boolean containsAll(Collection<?> c) {
        throwException(new UnsupportedOperationException("Sorry, we are not supporting this method"));
        return false;
    ...
    private class Itr implements Iterator<E> {
        ...
        public void forEachRemaining(Consumer<? super E> consumer) {
            ...
            final Object[] elementData = DIYarrayList.this.elementData;
            if (i >= elementData.length) {
                throw new ConcurrentModificationException();
            }
    ...
    private void throwException(UnsupportedOperationException e) {
            throw e;
    }
